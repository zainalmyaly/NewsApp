package com.designopera.news.Adapter;
...
import java.util.List;
  ...
  //this adapter to handel how card item will desplay
...
public  class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerViewHolder>{
    ...
    public RecyclerAdapter(Context context, List<News> uploads) {
        mContext = context;
        news = uploads;
    }
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int position) {
        ...
        holder.nameTextView.setText(currentNews.getName());
